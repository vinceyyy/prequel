                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500 mt-1">
                      Required: Interview will auto-destroy after this duration to prevent resource
                      waste
                    </p>
                  </div>
                      ...
                      <tr key={interview.id}>
                        ...
                        <td className="px-3 sm:px-6 py-4 text-sm font-medium">
                          <div className="flex flex-wrap gap-2 items-center">
                            ...
                            {interview.status === 'scheduled' && (
                              <button
                                onClick={() => cancelScheduledInterview(interview)}
                                className="btn-danger text-sm"
                              >
                                Cancel
                              </button>
                      ...
                      <tr key={interview.id}>
                        ...
                        <td className="px-3 sm:px-6 py-4 text-sm font-medium">
                          <div className="flex flex-wrap gap-2 items-center">
                            {interview.saveFiles ? (
                              <button
                                onClick={() => handleDownloadFiles(interview.id)}
