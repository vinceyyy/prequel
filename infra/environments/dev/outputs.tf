...
output "ecr_repository_url" {
  ...
  value       = module.environment.portal_ecr_repository_url
}

output "code_server_ecr_repository_url" {
  description = "Code server ECR repository URL"
  value       = module.environment.code_server_ecr_repository_url
}
...
output "portal_url" {
  ...
  value       = var.domain_name != "" ? "https://${var.domain_name}" : "http://${module.environment.alb_dns_name}"
}
...
output "alb_https_listener_arn" {
  ...
  value       = module.environment.alb_https_listener_arn
}

output "route53_zone_id" {
  description = "Route53 zone ID"
  value       = module.environment.route53_zone_id
}

output "challenge_bucket_name" {
  description = "Challenge S3 bucket name"
  value       = module.environment.challenge_bucket_name
}

output "ecs_execution_role_arn" {
  description = "ECS execution role ARN"
  value       = module.environment.ecs_execution_role_arn
}

output "ecs_task_role_arn" {
  description = "ECS task role ARN"
  value       = module.environment.ecs_task_role_arn
}

output "interview_cloudwatch_log_group_name" {
  description = "Interview CloudWatch log group name"
  value       = module.environment.interview_cloudwatch_log_group_name
}
